...
void DeviceContext::drawTriangle(UINT index_count, UINT vertex_count, UINT start_vertex_index)
{
	m_device_context->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP);
	m_device_context->DrawIndexed(index_count, vertex_count, start_vertex_index);
}
